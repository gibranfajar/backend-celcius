                            ...
                            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-center gap-2 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="plu" class="form-control" id="plu" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-center gap-2 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="sizechart" type="hidden" name="sizechart" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="size-stock-wrapper" class="mb-3"></div>
                                </div>
