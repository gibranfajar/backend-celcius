                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <form action="{{ $data ? route('pagehomes.update', $data->id) : route('pagehomes.store') }}"
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3">
                                        <label for="title">Title Banner (Women)</label>
                                        <input type="text" name="title" class="form-control"
                                            value="{{ $data ? $data->title : old('title') }}">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="bannertop_desktop_image">Banner Top Desktop (Women)</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="bannertop_desktop_image">Banner Top Mobile (Women)</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="bannerbottom_desktop_image">Banner Bottom Desktop (Women)</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="bannerbottom_desktop_image">Banner Bottom Mobile (Women)</label>
